...
export function SiteHeader({ active, orderNowHref, warmCanvas = false }: Props) {
  ...
  return (
    <>
      <div className="h-[4.5rem] shrink-0 sm:h-[4.25rem] lg:h-[5rem]" aria-hidden />
      <header className="pointer-events-none fixed left-0 right-0 top-0 z-[1055] flex justify-center px-3 pt-3 sm:px-4 sm:pt-4 lg:z-50">
        <div
