...
export default function KetoGuidesPage() {
  return (
    <div className="min-h-full bg-[#f4f1eb] font-sans text-[#426237]">
      ...
      <main className="mx-auto max-w-3xl px-4 pb-12 pt-3 sm:px-6">
        ...
        <article className="mt-4 rounded-[2rem] bg-white p-8 shadow-xl ring-1 ring-[#426237]/10 sm:p-10">
          <h1 className="menu-serif text-3xl font-semibold">Keto guides</h1>
          <p className="mt-4 text-sm leading-relaxed text-gray-600">
            Placeholder content. Add your approved guidance on net carbs, electrolytes, and which
            Balanced Bites SKUs fit a ketogenic pattern.
          </p>
        </article>
      </main>
      <SiteFooter />
